                    ...
                    <div class="content-order">
                        ...
                        <div class="service">
                            ...
                            <div class="button-detail">
                                <a class="confirm-detail" type="button" data-bs-toggle="modal" data-bs-target="#modalDetail"><svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                ...
                                <a class="menu-detail" type="button" data-bs-toggle="modal" data-bs-target="#modalEdit">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid info">
                                                ...
                                                <div class="row">
                                                    <h5>Keterangan</h5>
                                                    <p>mas saya mau service hp tidak bisa karena emyu kalah ga
                                                        tau lagi saya mau ngapain pokonya di service aja ya</p>
                                                </div>
                                                <div class="row">
